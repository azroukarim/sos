...
ادخل إلى مجلد البلوجين الذي تريد تشفيره (استبدل XPortal باسم مجلد البلوجين الخاص بك):
...
بعد الانتهاء بنجاح، قم بعمل إعادة تشغيل للـ GUI (الواجهة) للرسيفر لتفعيل البلوجين المشفر:

bash
killall -9 enigma2
💡 تذكر دائماً: احتفظ بنسخة من ملفات البلوجين بصيغة .py الأصلية على جهاز الكمبيوتر الخاص بك احتياطياً قبل البدء بالتشفير.
